...
// ---------------------------------------------------------------------------
function layer_text(distance, msg, t_size = 10, kerning_deg = 12, phase_shift = 0, location = "top") =
...
pattern_spec = [
                    layer_text(12, "CODE IS THE CHISEL-LIGHT IS THE CLAY", t_size = 32, kerning_deg = 7.5, location = "top", phase_shift=-6.9),
                     layer_text(12, "-2SCULPT-", t_size = 32, kerning_deg = 7.5, location = "bottom", phase_shift=-6.9),
 
    layer_circles(38, n = 20, duty = 0.65),
    layer_circles(25, n = 20, duty = 0.65),
    layer_rays(20.6, bar_h = _ray_bar_w * 2, n = 20, duty = 0.65),

    layer_polygon(15.4, 4,0,n = 20, duty = 0.65),
];

// ---------------------------------------------------------------------------
// 5. Preview
// ---------------------------------------------------------------------------
show_light_rays = false;   // set false for F6 export <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
